...
- Zoneamento proposto
- ZEIS prioritaria
- APP / area de preservacao
- Eixo estruturante
- Perimetro urbano
- Bairros e regioes
- Perimetro de interesse social

## Fluxo operacional

1. Cidadao ou equipe de campo registra contribuicao.
2. Sistema atribui protocolo, canal de origem, timestamp e vinculo territorial ou textual.
3. Equipe tecnica agrupa por tema, bairro, camada e instrumento urbanistico.
4. Equipe do Plano Diretor redige minuta de parecer.
5. Prefeitura valida, edita ou devolve para ajustes.
6. Conselho delibera quando houver impasse tecnico.
7. Cidadao recebe devolutiva e dados consolidados seguem para relatorio e GIS municipal.
...
- Volume de contribuicoes por bairro, tema e instrumento urbanistico.
- Tempo medio de triagem e resposta.
- Percentual de contribuicoes respondidas ou encaminhadas.
- Qualidade da exportacao para equipe tecnica e GIS municipal.
- Rastreabilidade entre contribuicao, analise, parecer e devolutiva.
